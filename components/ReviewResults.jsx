...
const ReviewResults = ({ corrects, mistakes, deckProgressPercent, onReviewAgain }) => {
  return (
    <div className="">
      <div className="flex flex-col gap-my-lg">
        <div className="bg-black rounded-lg border border-black-md p-9 flex gap-my-lg">
          <Image src={"/electron.png"} width={275} height={275} alt="image of an electron" />

          <div className="flex flex-col gap-my-md">
            <div className="flex gap-my-xs items-end">
              <span className="text-6xl text-my-primary font-medium">{corrects}</span>
        ...
        <div className="flex gap-my-md">
          <div className="bg-black border border-black-md p-9 px-12 rounded-lg">
